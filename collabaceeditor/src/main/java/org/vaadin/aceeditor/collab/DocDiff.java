...
public class DocDiff implements Diff<Doc> {
	...
	public static final Map<String, MarkerWithContext> NO_ADDED = Collections
			.emptyMap();
	public static final Map<String, MarkerDiff> NO_MOVED = Collections
			.emptyMap();
	...
	public static DocDiff removeMarkers(Collection<String> markerIds) {
		return new DocDiff(TextDiff.IDENTITY, NO_ADDED, NO_MOVED, markerIds);
	}
